...
app.post("/submit", (req, res) => {
  ...
  let randomNum1 = Math.floor(Math.random() * adj.length);
  // console.log(randomNum1);
  let randomNum2 = Math.floor(Math.random() * noun.length);
  // console.log(randomNum2);
  let adjName= adj[randomNum1];
  let nounName= noun[randomNum2];
  // console.log(adjName,nounName);
